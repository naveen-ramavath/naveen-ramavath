...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&pause=1000&color=36BCF7&center=true&vCenter=true&width=500&lines=Information+Technology+Student%3BPython+Developer%3BCybersecurity+Enthusiast" alt="Typing SVG" />
</p>
...
class Developer:
    def __init__(self):
        self.name = "Ramavath Naveen"
        self.college = "Chaitanya Bharathi Institute of Technology (CBIT)"
        self.degree = "B.E. in Information Technology (2023–2027)"
        self.skills = ["Python", "React", "JavaScript", "Full-Stack Development"]
        self.interests = ["Machine Learning", "Cybersecurity", "AI Chatbots"]
        
    def get_status(self):
        return "Building real-world projects & learning DSA!"
```
